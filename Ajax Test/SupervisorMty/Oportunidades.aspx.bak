<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SupervisorMty/SupervisorMty.Master" CodeBehind="Oportunidades.aspx.vb" Inherits="Ajax_Test.OportunidadesMty" %>
                ...
                <dx:ASPxGridView ID="GV_oportunidades" runat="server" Width="100%" Theme="Moderno" EnableCallBacks="False" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="Opciones" FieldName="id_cliente" VisibleIndex="0">
                            <PropertiesTextEdit DisplayFormatString="&lt;a href=&quot;/Supervisor/CambiaUsuario.aspx?idCliente={0}&quot; class=&quot;btn btn-sm green&quot;&gt;Asignar&lt;/a&gt;&lt;a href=&quot;/Supervisor/ClienteSupervisor.aspx?idCliente={0}&quot; class=&quot;btn btn-sm blue&quot;&gt;Detalles&lt;/a&gt;" EncodeHtml="False">
                            </PropertiesTextEdit>
