...
Public Class ModificaClienteMty
...
#End Region
    ...
    Protected Sub btn_verobservacion_Click(sender As Object, e As EventArgs) Handles btn_verobservacion.Click
        Response.Redirect("../SupervisorMty/DetalleObservaciones.aspx?idCliente=" + idCliente.ToString, False)
    End Sub
