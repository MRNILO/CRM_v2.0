<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SupervisorMty/SupervisorMty.master" CodeBehind="ReporteCumplimiento.aspx.vb" Inherits="Ajax_Test.ReporteCumplimientoMty" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i>Tabla de Datos Cumplimiento
            </div>
            <div class="tools">
        ...
        <div class="portlet-body">
            <div class="table-responsive">
                <dx:ASPxGridView ID="GV_CumplimientoData" runat="server" Width="100%" Theme="MaterialCompact">
                    <SettingsAdaptivity>
