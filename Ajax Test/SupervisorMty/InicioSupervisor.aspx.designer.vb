...
Partial Public Class InicioSupervisorMty
    ...
    '''<summary>
    '''Control GV_ClientesDias.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents GV_ClientesDias As Global.DevExpress.Web.ASPxGridView
End Class
