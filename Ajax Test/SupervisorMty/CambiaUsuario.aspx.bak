<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SupervisorMty/SupervisorMty.master" CodeBehind="CambiaUsuario.aspx.vb" Inherits="Ajax_Test.CambiaUsuarioMty" %>
