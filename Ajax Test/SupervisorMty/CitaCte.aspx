<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SupervisorMty/SupervisorMty.master" CodeBehind="CitaCte.aspx.vb" Inherits="Ajax_Test.CitaCteMty" %>
        ...
        <div class="portlet-body">
            <div class="table-scrollable">
                ...
                <dx:ASPxGridView ID="GV_citas" runat="server" Width="100%" Theme="MetropolisBlue" AutoGenerateColumns="False" Font-Size="9pt">
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="Id_Cita" Caption="Cita" VisibleIndex="0">
