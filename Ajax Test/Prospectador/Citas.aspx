<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Prospectador/Prospectador.Master" CodeBehind="Citas.aspx.vb" Inherits="Ajax_Test.Citas1" %>
        ...
        <div class="table-responsive">
            ...
            <asp:SqlDataSource ID="CitasDS" runat="server" ConnectionString="<%$ ConnectionStrings:crm_roest3ConnectionString %>"
                SelectCommand="SELECT
                               ...
                               WHERE CitasClientes.Origen = 'PROSPECTADOR'
                               ORDER BY
