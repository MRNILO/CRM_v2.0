Public Class MisDatos1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ValidaUsuario()
        Dim DatosUsuario = BL.Obtener_supervisor_Detalles(Usuario.id_usuario)
...
#End Region
    ...
    Private Sub btn_guardarDatos_Click(sender As Object, e As EventArgs) Handles btn_guardarDatos.Click
        If tb_contraseña.Text = tb_contraseñaRepite.Text Then
            ...
            Else
                If BL.Actualiza_contraseaSupervisor(Usuario.id_usuario, CalculateMD5Hash(tb_contraseña.Text)) Then
                Else
        ...
        If BL.Actualiza_supervisores(Usuario.id_usuario, tb_Nombre.Text, tb_apellidoPaterno.Text, tb_apellidoMaterno.Text, tb_email.Text, 1) Then
            ...
            Response.Redirect("../Supervisor/MisDatos.aspx", False)
        End If
    End Sub
