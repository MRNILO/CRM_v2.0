Public Class TareaUsuario
    ...
    Protected Sub btn_guardar_Click(sender As Object, e As EventArgs) Handles btn_guardar.Click
        If BL.Inserta_tareas(tb_Tarea.Text, cb_prioridad.SelectedValue, IdUsuario, 0, Now, dtp_fecha.Date, tp_hora.DateTime.ToString("HH:mm")) Then
            Response.Redirect("../Supervisor/Usuario.aspx?idUsuario=" + IdUsuario.ToString, False)
        Else
