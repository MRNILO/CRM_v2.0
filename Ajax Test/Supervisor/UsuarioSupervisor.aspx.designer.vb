...
Partial Public Class UsuarioSupervisor
    ...
    '''<summary>
    '''Control tb_IdUsuario.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents tb_IdUsuario As Global.System.Web.UI.WebControls.TextBox
    
    '''<summary>
    '''Control tb_NombreUsuario.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents tb_NombreUsuario As Global.System.Web.UI.WebControls.TextBox
    ...
    '''<summary>
    '''Control grdView_BusquedaUsuarios.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents grdView_BusquedaUsuarios As Global.DevExpress.Web.ASPxGridView
    ...
    '''<summary>
    '''Control cmBoxSupervisores.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cmBoxSupervisores As Global.DevExpress.Web.ASPxComboBox
