...
Public Class ClienteSupervisor
    ...
    Dim Conexion As New SqlConnection("Data Source=PCDESARROLLO01\DESAJORGE;Initial Catalog=crm_edificasa;Persist Security Info=True;User ID=sa;Password=DesaJorge")
