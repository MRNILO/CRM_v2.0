<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Supervisor/Supervisor.Master" CodeBehind="ReporteCalidad.aspx.vb" Inherits="Ajax_Test.ReporteCalidad" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i>Tabla de Datos Calidad
            </div>
            <div class="tools">
        ...
        <div class="portlet-body">
            <div class="table-responsive">
                <dx:ASPxGridView ID="GV_CalidadData" runat="server" Width="100%" Theme="MaterialCompact">
                    <SettingsAdaptivity>
